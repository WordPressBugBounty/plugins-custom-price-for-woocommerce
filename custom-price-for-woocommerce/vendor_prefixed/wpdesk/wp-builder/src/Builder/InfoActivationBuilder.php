...
namespace CPWFreeVendor\WPDesk\PluginBuilder\Builder;
...
use CPWFreeVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\CPWFreeVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
