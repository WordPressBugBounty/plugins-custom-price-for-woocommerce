...
class WPCapture
{
    ...
    private function add_notice_for_dir($dir)
    {
        new \CPWFreeVendor\WPDesk\Notice\Notice(sprintf(
            ...
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'custom-price-for-woocommerce'),
            $dir
    ...
    private function add_notice_for_file($file)
    {
        new \CPWFreeVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'custom-price-for-woocommerce'),
            $file
        ), \CPWFreeVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
