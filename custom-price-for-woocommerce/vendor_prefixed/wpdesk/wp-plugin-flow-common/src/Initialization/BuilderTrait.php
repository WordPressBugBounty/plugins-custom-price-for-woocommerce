...
namespace CPWFreeVendor\WPDesk\Plugin\Flow\Initialization;

use CPWFreeVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use CPWFreeVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use CPWFreeVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use CPWFreeVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\CPWFreeVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\CPWFreeVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
