...
use CPWFreeVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use CPWFreeVendor\Monolog\Logger;
use CPWFreeVendor\Monolog\Formatter\FormatterInterface;
use CPWFreeVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use CPWFreeVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use CPWFreeVendor\Elasticsearch\Client;
use CPWFreeVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use CPWFreeVendor\Elastic\Elasticsearch\Client as Client8;
/**
