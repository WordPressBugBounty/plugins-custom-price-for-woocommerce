...
namespace CPWFreeVendor\Psr\Log\Test;

use CPWFreeVendor\Psr\Log\LoggerInterface;
use CPWFreeVendor\Psr\Log\LogLevel;
use CPWFreeVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('CPWFreeVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('CPWFreeVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('CPWFreeVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
